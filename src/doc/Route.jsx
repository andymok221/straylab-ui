...
import TagDoc from './page/TagDoc';
      ...
      <BrowserRouter>
        <div className="docs-container">
          <div className="navbar">
            <div className="navbar__logo">StrayLab</div>
            <ul className="navbar__list">
              ...
              <hr />
              <li>
                <Link activeClassName="active" to="/button">
                  Button
                </Link>
              </li>
              <li>
                <Link activeClassName="active" to="/checkbox">
                  Checkbox
                </Link>
              </li>
              <li>
                <Link activeClassName="active" to="/form">
                  Form
                </Link>
              </li>
              <li>
                <Link activeClassName="active" to="/input">
                  Input
                </Link>
              </li>
              <li>
                <Link activeClassName="active" to="/label">
                  Label
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link activeClassName="active" to="/modal">
                  Modal
                </Link>
              </li>
              <li>
                <Link activeClassName="active" to="/off-canvas">
                  Off Canvas
                </Link>
              </li>
              <li>
                <Link activeClassName="active" to="/pagination">
                  Pagination
                </Link>
              </li>
              <li>
                <Link activeClassName="active" to="/pie">
                  Pie
                </Link>
              </li>
              <li>
                <Link activeClassName="active" to="/progress">
                  Progress
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link activeClassName="active" to="/table">
                  Table
                </Link>
              </li>
              <li>
                <Link activeClassName="active" to="/tab-pane">
                  Tab Pane
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link activeClassName="active" to="/tooltip">
                  Tooltip
                </Link>
              </li>
            </ul>
          ...
          <div className="main-content">
            ...
            <Switch>
              ...
              <Route exact path="/tag" component={TagDoc} />
